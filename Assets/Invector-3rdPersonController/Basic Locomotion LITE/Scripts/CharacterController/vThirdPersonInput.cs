...
namespace Invector.CharacterController
{
    public class vThirdPersonInput : MonoBehaviour
    {
        ...
        private SingleJoystick _singleJoystick;
        ...
        {
            CharacterInit();
            _singleJoystick = FindObjectOfType<SingleJoystick>();
        }
...
*/
            cc.input.x = _singleJoystick.GetInputDirection().x;
            cc.input.y = _singleJoystick.GetInputDirection().y;
        }
